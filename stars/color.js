const TbyBV = (bv)=>(4600 * ((1 / ((0.92 * bv) + 1.7)) +(1 / ((0.92 * bv) + 0.62))))
...
function bv_to_rgb(bv) {
  ...
  //linear RGB to sRGB
  var R = (r <= 0.0031308)? 12.92*r : 1.055*Math.pow(r,2)-0.055
  var G = (g <= 0.0031308)? 12.92*g : 1.055*Math.pow(g,2)-0.055
  var B = (b <= 0.0031308)? 12.92*b : 1.055*Math.pow(b,2)-0.055
